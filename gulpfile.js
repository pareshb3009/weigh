...
gulp.task('tinymce_plugins', function() {
    var dest = paths.build + 'plugins';
    log('Copying tinymce_plugins');
    return gulp
        .src(paths.tinymce_plugins)
        .pipe(gulp.dest(dest))
        .pipe(connect.reload());
});

gulp.task('tinymce_skins', function() {
    var dest = paths.build + 'skins';
    log('Copying tinymce_skins');
    return gulp
        .src(paths.tinymce_skins)
        .pipe(gulp.dest(dest))
        .pipe(connect.reload());
});

gulp.task('tinymce_themes', function() {
    var dest = paths.build + 'themes';
    log('Copying tinymce_themes');
    return gulp
        .src(paths.tinymce_themes)
        .pipe(gulp.dest(dest))
        .pipe(connect.reload());
});
 ...
 * @return {Stream}
 */
gulp.task('build', ['rev-and-inject', 'images', 'fonts','watch','connect', 'tinymce_plugins','tinymce_skins','tinymce_themes'], function() {
